...
func (_m *UserRepository) CreateUser(ctx context.Context, user domain.User) (int64, error) {
...
// GetUserByFirebaseUID provides a mock function with given fields: ctx, uuid
func (_m *UserRepository) GetUserByFirebaseUID(ctx context.Context, uuid string) (domain.User, error) {
