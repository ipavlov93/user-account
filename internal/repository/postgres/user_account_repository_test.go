...
func TestListUserAccountByUserID(t *testing.T) {
	...
	rows := sqlmock.NewRows(
		...
		AddRow(expectedUserAccount1.ID, expectedUserAccount1.UserID, expectedUserAccount1.Issuer, expectedUserAccount1.SubjectUID, expectedUserAccount1.EmailAddress, expectedUserAccount1.ContactName).
		AddRow(expectedUserAccount2.ID, expectedUserAccount2.UserID, expectedUserAccount2.Issuer, expectedUserAccount2.SubjectUID, expectedUserAccount2.EmailAddress, expectedUserAccount2.ContactName)
...
func TestCreateUserAccount(t *testing.T) {
	...
	mock.ExpectQuery(
		...
		WithArgs(newUserAccount.UserID, newUserAccount.Issuer, newUserAccount.SubjectUID, newUserAccount.EmailAddress, newUserAccount.ContactName).
